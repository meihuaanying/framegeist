...
const DICT = {
  zh: {
    ...
    "f1.t": "184 套内置模板 · 25 分类 · 106 种拼图", "f1.d": "白边、胶片齿孔、拍立得、杂志排版、色卡、日历、票根、航拍、节庆——全部 JSON 声明式，可自制可流通。",
    ...
    "wall.title": "模板墙", "wall.note": "以下样张由 CLI 用真实演示摄影渲染（Unsplash License），禁止设计稿冒充。",
    "wall.all": "全部",
    "wall.count": "共 {n} 套",
    "cat.white-border": "白边", "cat.camera": "相机", "cat.phone": "手机", "cat.drone": "航拍",
    "cat.fuji": "富士配方", "cat.film": "胶片", "cat.colorwalk": "色彩漫步", "cat.colorful": "多彩",
    "cat.classic-watermark": "经典水印", "cat.portfolio": "作品集", "cat.black-frame": "黑框", "cat.sports": "运动",
    "cat.calendar": "日历", "cat.magazine": "杂志", "cat.minimal": "极简", "cat.borderless": "无边框",
    "cat.master": "大师", "cat.personal": "个人", "cat.polaroid": "拍立得", "cat.festival": "节日",
    "cat.effect": "特效", "cat.colorcard": "色卡", "cat.blur-bg": "模糊背景", "cat.ticket": "票根",
    "cat.game": "游戏主题",
  ...
  en: {
    ...
    "f1.t": "184 templates · 25 categories · 106 layouts", "f1.d": "White borders, film sprockets, instant, magazine, color cards, calendars, tickets, aerial, festival — all declarative JSON, maker-friendly.",
    ...
    "wall.title": "Template wall", "wall.note": "Every thumbnail is a real CLI render with curated demo photography (Unsplash License) — never a design mock.",
    "wall.all": "All",
    "wall.count": "{n} templates",
    "cat.white-border": "White border", "cat.camera": "Camera", "cat.phone": "Phone", "cat.drone": "Drone",
    "cat.fuji": "Fuji recipes", "cat.film": "Film", "cat.colorwalk": "Color walk", "cat.colorful": "Colorful",
    "cat.classic-watermark": "Classic", "cat.portfolio": "Portfolio", "cat.black-frame": "Black frame", "cat.sports": "Sports",
    "cat.calendar": "Calendar", "cat.magazine": "Magazine", "cat.minimal": "Minimal", "cat.borderless": "Borderless",
    "cat.master": "Master", "cat.personal": "Personal", "cat.polaroid": "Instant", "cat.festival": "Festival",
    "cat.effect": "Effect", "cat.colorcard": "Color card", "cat.blur-bg": "Blurred", "cat.ticket": "Ticket",
