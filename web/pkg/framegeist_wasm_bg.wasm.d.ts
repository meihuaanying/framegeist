...
export const engine_register_asset: (a: number, b: number, c: number, d: number, e: number) => void;
...
export const engine_render_free_collage: (a: number, b: any, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
