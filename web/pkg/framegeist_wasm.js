...
export class Engine {
     ...
     */
    constructor(font_names, font_bytes) {
        const ptr0 = passArrayJsValueToWasm0(font_names, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(font_bytes, wasm.__wbindgen_malloc);
    ...
    probe_exif(photo) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.engine_probe_exif(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {Uint8Array}
     */
    render(photo, template_json, format, preview) {
        const ptr0 = passArray8ToWasm0(photo, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
    ...
    validate_template(json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.engine_validate_template(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('framegeist_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
